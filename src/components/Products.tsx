...
const products = [
  ...
  },
  {
    id: "slaydpro",
    name: "SlaydPro",
    tagline: { uz: "Self-hosted", ru: "Self-hosted", en: "Self-hosted" },
    description: {
      uz: "AI prezentatsiya generatori. O'z serveringizda o'rnatib, cheksiz foydalaning.",
      ru: "AI генератор презентаций. Установите на свой сервер без ограничений.",
      en: "AI presentation generator. Install on your server and use without limits.",
    },
    icon: FileCode2,
    gradient: "from-green-500 to-emerald-600",
    features: {
      uz: ["Self-hosted", "Docker deployment", "Ko'p AI model", "Self-hosted"],
      ru: ["Self-hosted", "Docker деплой", "Много AI моделей", "Self-hosted"],
      en: ["Self-hosted", "Docker deployment", "Multiple AI models", "Self-hosted"],
    },
    stats: "Self-hosted",
    link: "#",
    badge: "Self-hosted",
