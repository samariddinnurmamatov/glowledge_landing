...
const posts: {
  ...
  },
  {
    ...
    title: {
      uz: "SlaydPro'ni Docker bilan o'z serveringizda o'rnatish",
      ru: "Установка SlaydPro с Docker на своём сервере",
      en: "Installing SlaydPro with Docker on your own server",
    },
    excerpt: {
      uz: "SlaydPro AI prezentatsiya generatorini o'z serveringizga o'rnatish bo'yicha to'liq qo'llanma.",
      ru: "Полное руководство по установке SlaydPro AI генератора презентаций на собственный сервер.",
      en: "Complete guide to installing the SlaydPro AI presentation generator on your server.",
    },
