...
const team = [
  { name: "Shahzod Alimardanov", role: { uz: "Asoschi & CEO", ru: "Основатель и CEO", en: "Founder & CEO" }, bio: { uz: "Glowledgeni yaratdi va rivojlantirmoqda", ru: "Создал и развивает Glowledge", en: "Created and developing Glowledge" }, emoji: "⭐", gradient: "from-indigo-500 to-purple-600" },
  { name: "Samariddin Nurmamatov", role: { uz: "Frontend & AI Engineer", ru: "Frontend & AI Engineer", en: "Frontend & AI Engineer" }, bio: { uz: "Foydalanuvchi interfeysi va AI integratsiyasi", ru: "Пользовательский интерфейс и AI интеграция", en: "User interface and AI integration" }, emoji: "🚀", gradient: "from-blue-500 to-cyan-500" },
  { name: "Rahmiddin Dehqonov", role: { uz: "AI Engineer", ru: "AI Engineer", en: "AI Engineer" }, bio: { uz: "AI modellar va backend arxitekturasi", ru: "AI модели и backend архитектура", en: "AI models and backend architecture" }, emoji: "🧠", gradient: "from-purple-500 to-pink-500" },
  { name: "Mo\u02BBtabarxon Turdaliyeva", role: { uz: "UI/UX Dizayner", ru: "UI/UX Дизайнер", en: "UI/UX Designer" }, bio: { uz: "Foydalanuvchi tajribasi va vizual dizayn", ru: "Пользовательский опыт и визуальный дизайн", en: "User experience and visual design" }, emoji: "🌐", gradient: "from-pink-500 to-rose-500" },
  { name: "Diyorbek Xazratqulov", role: { uz: "Backend Developer", ru: "Backend Developer", en: "Backend Developer" }, bio: { uz: "Server va ma'lumotlar bazasi arxitekturasi", ru: "Серверная и база данных архитектура", en: "Server and database architecture" }, emoji: "💎", gradient: "from-cyan-500 to-blue-500" },
  { name: "Bexruz Maxmudov", role: { uz: "AI Engineer", ru: "AI Engineer", en: "AI Engineer" }, bio: { uz: "AI model optimallashtirish va tayyorlash", ru: "Оптимизация и подготовка AI моделей", en: "AI model optimization and training" }, emoji: "⚡", gradient: "from-yellow-500 to-orange-500" },
  { name: "Hamroh Print", role: { uz: "Evaluator", ru: "Оценщик", en: "Evaluator" }, bio: { uz: "Sifat nazorati va mahsulot baholash", ru: "Контроль качества и оценка продукта", en: "Quality control and product evaluation" }, emoji: "🖨️", gradient: "from-green-500 to-emerald-500" },
  { name: "Doniyorbek", role: { uz: "Moliya", ru: "Финансы", en: "Finance" }, bio: { uz: "Moliyaviy strategiya va operatsiyalar", ru: "Финансовая стратегия и операции", en: "Financial strategy and operations" }, emoji: "💰", gradient: "from-amber-500 to-yellow-500" },
];
