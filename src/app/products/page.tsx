...
const products = [
  ...
  },
  {
    ...
    platform: { uz: "Open-source (Docker)", ru: "Open-source (Docker)", en: "Open-source (Docker)" },
    badge: { uz: "Open-source", ru: "Open-source", en: "Open-source" },
    badgeColor: "#10b981",
    ...
    desc: {
      uz: "Presenton — ochiq kodli AI prezentatsiya generatori. Docker bilan o'z serveringizga o'rnating, cheksiz va bepul foydalaning. Katta tashkilotlar va dasturchilar uchun ideal.",
      ru: "Presenton — open-source AI генератор презентаций. Установите через Docker на свой сервер, используйте безлимитно и бесплатно. Идеально для крупных организаций и разработчиков.",
      en: "Presenton — open-source AI presentation generator. Install via Docker on your server, use unlimitedly and for free. Ideal for large organizations and developers.",
    },
    forWhom: { uz: "Dasturchilar va tashkilotlar", ru: "Разработчики и организации", en: "Developers and organizations" },
    outputs: ["PPTX", "PDF"],
    features: {
      uz: ["To'liq open-source", "Docker bilan o'rnatish", "Cheksiz va bepul", "O'z serveringizda", "API integratsiya", "Maxsus sozlash"],
      ru: ["Полностью open-source", "Установка через Docker", "Безлимитно и бесплатно", "На своём сервере", "API интеграция", "Кастомизация"],
      en: ["Fully open-source", "Docker installation", "Unlimited and free", "On your own server", "API integration", "Custom configuration"],
    },
  },
  {
    slug: "ai-docx-editor",
