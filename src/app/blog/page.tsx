...
const posts = [
  ...
  },
  {
    ...
    title: { uz: "Presenton'ni Docker bilan o'z serveringizda o'rnatish", ru: "Установка Presenton с Docker на своём сервере", en: "Installing Presenton with Docker on your own server" },
    excerpt: { uz: "Ochiq kodli AI prezentatsiya generatorini o'z serveringizga o'rnatish bo'yicha to'liq qo'llanma. Docker, environment variables va sozlashlar.", ru: "Полное руководство по установке open-source AI генератора презентаций на собственный сервер. Docker, переменные среды и настройки.", en: "Complete guide to installing the open-source AI presentation generator on your own server. Docker, environment variables and settings." },
